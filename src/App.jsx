        ...
        {isOpen && (
          ...
          >
            <div className="flex flex-col gap-2">
              ...
              <button className="w-full py-4 bg-[#d84040] text-white font-bold rounded-xl mt-2 shadow-lg shadow-red-200">
                Unduh Aplikasi
              </button>
            </div>
          </motion.div>
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          >
            ...
            <h1 className="**text-4xl md:text-5xl lg:text-6xl** font-black text-slate-900 leading-[0.95] mb-8 tracking-tight">
                WAWANCARA? <br/>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <motion.button 
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="px-8 py-4 bg-[#d84040] text-white rounded-2xl font-bold text-lg shadow-xl shadow-red-200 flex items-center justify-center gap-3"
              >
                <Download size={24} />
                Download APK
              </motion.button>
